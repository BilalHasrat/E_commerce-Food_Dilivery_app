...
import 'package:e_commers_app/database_service/auth_service.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  uploadItem() async {
    if (selectedImage != null) {
      ...
      await SharedPreferenceHelper().saveUserProfilePic(downloadUrl);
      setState(() {
  ...
  getthesharedpref() async {
    profile = await SharedPreferenceHelper().getUserProfilePic();
